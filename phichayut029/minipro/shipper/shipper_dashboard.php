                    ...
                    <tbody>
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                $statusColor = ($row['status'] == 'Pending') ? 'bg-warning text-dark' : 'bg-info text-dark';

                                // สร้างลิ้งค์ Google Maps (ค้นหาตามที่อยู่)
                                ...
                                <tr>
                                    <td class="ps-4">
                                        ...
                                        <small
                                            class="text-muted"><?php echo ($row['destination_type'] == 'domestic') ? 'ในประเทศ' : 'ต่างประเทศ'; ?></small>
                                    </td>
                                    <td class="text-white">
                                        <i class="bi bi-person-fill text-muted"></i> <?php echo $row['recipient_name']; ?> <br>
                                        <small class="text-muted"><i class="bi bi-telephone"></i> <a
                                                href="tel:<?php echo $row['recipient_phone']; ?>"
                                                class="text-decoration-none text-muted"><?php echo $row['recipient_phone']; ?></a></small>
                                    </td>
                                    <td class="text-white-50">
                                        <div style="max-width: 250px; white-space: normal;">
                                            <?php echo $row['recipient_address']; ?></div>
                                        <div class="mt-2">
                                    ...
                                    <td><span class="badge <?php echo $statusColor; ?>"><?php echo $row['status']; ?></span>
                                    </td>
